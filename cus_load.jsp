	...
	try {
	   ...
	   reviewList = review.getCusReview(revCount, pet_id);
		...
		while (rs.next()) {
			...
			divstr += "         <div id='carouselExampleFade" + cnt + "' class='carousel slide carousel-fade' data-ride='carousel'>";
			divstr += "            <div class='carousel-inner'>";
			divstr += "               <div class='carousel-item active'> ";
			divstr += "                  <img class='d-block w-100' src='imageFile/" + rs.getString("pet_intro1").toString() + "'>";
			divstr += "               </div>  ";
			divstr += "               <div class='carousel-item'> ";
			divstr += "                  <img class='d-block w-100' src='imageFile/" + rs.getString("pet_intro2").toString() + "'>";
			divstr += "               </div>  ";
			divstr += "               <div class='carousel-item'>  ";
			divstr += "                  <img class='d-block w-100' src='imageFile/" + rs.getString("pet_intro3").toString() + "'>";
			divstr += "               </div>  ";
			divstr += "            </div>";
			divstr += "            <a class='carousel-control-prev' href='#carouselExampleFade" + cnt + "' role='button' data-slide='prev'>";
			divstr += "               <span class='carousel-control-prev-icon' aria-hidden='true'></span>";
			divstr += "               <span class='sr-only'>Previous</span>";
			divstr += "            </a>";
			divstr += "            <a class='carousel-control-next' href='#carouselExampleFade" + cnt + "' role='button' data-slide='next'>";
			...
			divstr += "        	 	<label><i class='fas fa-map-marker-alt'></i>&nbsp;&nbsp;" + pet_addr + "</label> ";
			divstr += "			</div>";
		...
		/* 
			divstr += "			<div class='col-md-3' id='gold'>";
		 	divstr += " 		<label style='font-weight: bold; font-size:20px; color:#384158; padding-left:100px; padding-top:28px;'>" + revStarAvg +"</label>         ";
			divstr += "			</div>";
		*/
			...
			divstr += "         </i>";
			divstr += "         <label id='cardcomment'>고객후기 " + revCountss + "개</label>      ";
			divstr += "       </div>";
