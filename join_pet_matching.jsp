		...
		<div class="card">
			<div class="card-body">
				...
				<div class="row">
						...
						<div class="col-md-11">
						<label style="font-size:17px; font-weight:bold; padding-top:30px;"> 모든 문항에 응답하지 않으면 펫시터님을 원하는 고객에게 매칭되지 않습니다. <br>
						모든 문항에 정확히 응답해주세요. </label>
						</div>
				</div>
						
					<form class="form" method="post"  action="join_pet_matching_pro.jsp?pet_id=<%= pet_id%>">
						<div class="form-group col-md-offset-3" style="padding-top:40px;">
							<label for="qna" style="font-weight:bold;">1. 본인의 주거 형태를 알려주세요.</label>
						...
						<div class="form-group col-md-offset-3">
							<label for="qna" style="font-weight:bold;">2. 반려견에게 수제간식을 제공해주실 수 있나요?</label>
							<div style="margin-top: 10px;">
						...
						<div class="form-group col-md-offset-3">
							<div class="input-group">
								<label for="qna" style="font-weight:bold;">3. 어떤 반려견까지 케어 가능하신가요?</label>
						...
						<div style="margin-top: 10px;">
							<label><input type="checkbox" class="ck1" name="ck1" value="0" /><span id="tag">노령견 케어</span></label>
							<label><input type="checkbox" class="ck1" name="ck1" value="1" /><span id="tag">질병견 케어</span></label> 
							<label><input type="checkbox" class="ck1" name="ck1" value="2" /><span id="tag">장애견 케어</span></label>
							<label><input type="checkbox" class="ck1" name="ck1" value="3" /><span id="tag">발정견 케어</span></label> 
							<label><input type="checkbox" class="ck1" name="ck1" value="4" /><span id="tag">임신견 케어</span></label>
						</div>
						<br>
						<div class="form-group col-md-offset-3">
							<label for="qna" style="font-weight:bold;">4. 고객의 반려견이 돌봄 기간 중 아플 경우, 어떻게 해주실 수 있나요?</label>
							<div style="margin-top: 10px;">
						...
						<div class="form-group col-md-offset-3">
							<div class="input-group">
								<label for="qna" style="font-weight:bold;">5. 고객의 반려견과 가고 싶은 곳이 있나요?</label>
								<label class="genderrb" style="margin-left: 20px;">
									전체선택 <b>(중복 선택 가능)</b>
									<input type="checkbox" id='checkall2' name="all2" /><span class="rb"></span>
								</label>
							</div>
						</div>
						<div style="margin-top: 10px;">
						...
						<br>
						<div class="form-group col-md-offset-3">
							<label for="qna" style="font-weight:bold;">6. 고객의 반려견을 목욕시키실 수 있나요?</label>
							<div style="margin-top: 10px;">
						...
						<br>
						<div class="form-group col-md-offset-3">
							<label for="qna" style="font-weight:bold;">7. 고객의 반려견을 훈련시키실 수 있나요?</label>
							<div style="margin-top: 10px;">
						...
						<br>
						<div class="form-group col-md-offset-3">
							<label for="qna" style="font-weight:bold;">8. 고객의 반려견과 반려견을 주로 어디서 케어하시나요?</label>
							<div style="margin-top: 10px;">
						...
						<br>
						<div class="form-group col-md-offset-3">
							<label for="qna" style="font-weight:bold;">9. 본인은 반려견을 키우시나요?</label>
							<div style="margin-top: 10px;">
						...
						<div id="medog" style="display: none;">
							<div class="form-group col-md-offset-3">
								<label for="qna" style="font-weight:bold;">10. 본인 반려견의 크기를 알려주세요.</label>
								<div style="margin-top: 10px;">
						...
						<div class="form-group text-right">
							<input type="button" value="이전" class="btn btn-light" style="width:80px;" onclick="history.go(-1);">
							<button type="submit" id="colorch" class="btn btn-light" style="width:80px;" >완료</button>
						</div>
					</form>
				</div>
			</div>
